...
namespace SchoolProjectInfrastrcure.Migrations
{
    ...
    [Migration("20240721221906_ttttt")]
    partial class ttttt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolProjectData.Entities.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolProjectData.Entities.Identity.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SchoolProjectData.Entities.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolProjectData.Entities.Identity.UserRefreshToken", b =>
                {
                    b.HasOne("SchoolProjectData.Entities.Identity.User", "user")
